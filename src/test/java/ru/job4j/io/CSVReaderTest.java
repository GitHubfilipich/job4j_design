...
class CSVReaderTest {
    ...
    @Test
    void whenFilterTwoColumnsStandardOutput(@TempDir Path folder) throws Exception {
        String data = String.join(
                System.lineSeparator(),
                "name;age;last_name;education",
                "Tom;20;Smith;Bachelor",
    ...
    @Test
    void whenFilterThreeColumnsStandardOutput(@TempDir Path folder) throws Exception {
        String data = String.join(
                System.lineSeparator(),
                "name,age,last_name,education",
                "Tom,20,Smith,Bachelor",
