...
public class SimpleTreeTest {
    ...
    void whenChildNotExistOnLeafThenAdd() {
        ...
        tree.add(4, 5);
        tree.add(5, 6);
        assertThat(tree.add(1, 7)).isTrue();
    }

    @Test
    void whenChildNotExistAndParentNotExistOnLeafThenNotAdd() {
        Tree<Integer> tree = new SimpleTree<>(1);
        tree.add(1, 2);
        tree.add(1, 3);
        tree.add(1, 4);
    ...
    @Test
    void whenChildNotExistThenTrue() {
        SimpleTree<Integer> tree = new SimpleTree<>(1);
        assertThat(tree.isBinary()).isTrue();
    }

    @Test
    void whenHasMax2ChildrenThenTrue() {
        SimpleTree<Integer> tree = new SimpleTree<>(1);
        tree.add(1, 2);
        tree.add(1, 3);
        tree.add(2, 4);
    ...
    @Test
    void whenHasMax3ChildrenThenTrue() {
        SimpleTree<Integer> tree = new SimpleTree<>(1);
        tree.add(1, 2);
        tree.add(1, 3);
        tree.add(2, 4);
