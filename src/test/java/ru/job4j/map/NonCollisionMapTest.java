...
class NonCollisionMapTest {
    ...
    @Test
    void whenCheckGetPresentAndAbsentKey() {
    ...
    @Test
    void whenCheckRemovePresentAndAbsentKey() {
    ...
    @Test
    void whenCheckRemoveAfterExpand() {
        assertThat(map.put(5, "5")).isTrue();
        assertThat(map.put(6, "6")).isTrue();
        assertThat(map.put(7, "7")).isTrue();
        assertThat(map.put(8, "8")).isTrue();
        ...
        assertThat(map.remove(9)).isFalse();
        assertThat(map).hasSize(7);
    }
    ...
    @Test
    void whenCheckIteratorHasNextConcurrentModificationAfterExpand() {
        assertThat(map.put(5, "5")).isTrue();
        assertThat(map.put(6, "6")).isTrue();
        assertThat(map.put(7, "7")).isTrue();
        assertThat(map.put(8, "8")).isTrue();
    ...
    @Test
    void whenCheckIteratorNextConcurrentModificationAfterExpand() {
        assertThat(map.put(5, "5")).isTrue();
        assertThat(map.put(6, "6")).isTrue();
        assertThat(map.put(7, "7")).isTrue();
        assertThat(map.put(8, "8")).isTrue();
