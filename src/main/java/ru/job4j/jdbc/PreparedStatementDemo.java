...
public class PreparedStatementDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        preparedStatementDemo.insert(new City(1, "Ufa", 20));

        City msk = new City(2, "Moscow", 100);
        preparedStatementDemo.insert(msk);
        preparedStatementDemo.insert(new City(3, "SPb", 200));
        System.out.println("after insert");
        preparedStatementDemo.findAll().forEach(System.out::println);

        msk.setPopulation(150);
        preparedStatementDemo.update(msk);
        System.out.println("after update");
        preparedStatementDemo.findAll().forEach(System.out::println);

        preparedStatementDemo.delete(3);
